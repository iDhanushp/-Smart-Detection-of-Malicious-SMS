...
# Fallback to standalone Keras if tf.keras alias is missing (TF 2.10 quirk)
try:
    import keras as _keras  # standalone package
    import sys as _sys
    _sys.modules['tensorflow.keras'] = _keras  # register alias
...
Usage (inside the activated Python-3.9 environment):

    python export_tflite_3class.py
